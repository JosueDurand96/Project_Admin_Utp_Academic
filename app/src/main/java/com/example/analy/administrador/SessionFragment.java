...
import com.example.analy.administrador.tablas.Administrador;
...
public class SessionFragment extends Fragment  implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            cliente.setIdadmin(jsonObject.optString("idadmin"));
        ...
        i.putExtra(id,cliente.getIdadmin() );
        //  Toast.makeText(getContext(), ""+administrador.getIdadmin(), Toast.LENGTH_SHORT).show();
        startActivity(i);

    }
    private void iniciarSesion() {
        String url ="http://www.capacitasoft.com/site/Prueba/Admin/login.php?"+
